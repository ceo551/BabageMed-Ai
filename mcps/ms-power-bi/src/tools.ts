...
// Microsoft Power BI — connector observed in the Perplexity Computer Connectors
...
// authenticate.
const HOMEPAGE = "https://powerbi.microsoft.com";
const NOT_CONFIGURED = {
  status: "not-configured",
  message: "Microsoft Power BI connector is registered but not yet authenticated. Add credentials in Settings → Connectors.",
  homepage: HOMEPAGE,
};
...
export function registerTools(server: McpServer) {
  server.tool({
    name: "search",
    description: "Search Microsoft Power BI. Returns 'not-configured' until OAuth/API credentials are supplied.",
  ...
  server.tool({
    name: "fetch",
    description: "Fetch a record from Microsoft Power BI by id or URL. Stub until configured.",
