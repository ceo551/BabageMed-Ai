...
// Connectwise PSA — connector observed in the Perplexity Computer Connectors
...
// authenticate.
const HOMEPAGE = "https://www.connectwise.com/platform/business-management/psa";
const NOT_CONFIGURED = {
  status: "not-configured",
  message: "Connectwise PSA connector is registered but not yet authenticated. Add credentials in Settings → Connectors.",
  homepage: HOMEPAGE,
};
...
export function registerTools(server: McpServer) {
  server.tool({
    name: "search",
    description: "Search Connectwise PSA. Returns 'not-configured' until OAuth/API credentials are supplied.",
  ...
  server.tool({
    name: "fetch",
    description: "Fetch a record from Connectwise PSA by id or URL. Stub until configured.",
