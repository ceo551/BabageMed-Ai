...
// YouTube Data — connector observed in the Perplexity Computer Connectors
...
// authenticate.
const HOMEPAGE = "https://developers.google.com/youtube/v3";
const NOT_CONFIGURED = {
  status: "not-configured",
  message: "YouTube Data connector is registered but not yet authenticated. Add credentials in Settings → Connectors.",
  homepage: HOMEPAGE,
};
...
export function registerTools(server: McpServer) {
  server.tool({
    name: "search",
    description: "Search YouTube Data. Returns 'not-configured' until OAuth/API credentials are supplied.",
  ...
  server.tool({
    name: "fetch",
    description: "Fetch a record from YouTube Data by id or URL. Stub until configured.",
