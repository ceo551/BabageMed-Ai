...
// Google Business Profile — connector observed in the Perplexity Computer Connectors
...
// authenticate.
const HOMEPAGE = "https://www.google.com/business";
const NOT_CONFIGURED = {
  status: "not-configured",
  message: "Google Business Profile connector is registered but not yet authenticated. Add credentials in Settings → Connectors.",
  homepage: HOMEPAGE,
};
...
export function registerTools(server: McpServer) {
  server.tool({
    name: "search",
    description: "Search Google Business Profile. Returns 'not-configured' until OAuth/API credentials are supplied.",
  ...
  server.tool({
    name: "fetch",
    description: "Fetch a record from Google Business Profile by id or URL. Stub until configured.",
