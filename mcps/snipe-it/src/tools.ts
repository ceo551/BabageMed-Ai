...
// Snipe-IT — connector observed in the Perplexity Computer Connectors
...
// authenticate.
const HOMEPAGE = "https://snipeitapp.com";
const NOT_CONFIGURED = {
  status: "not-configured",
  message: "Snipe-IT connector is registered but not yet authenticated. Add credentials in Settings → Connectors.",
  homepage: HOMEPAGE,
};
...
export function registerTools(server: McpServer) {
  server.tool({
    name: "search",
    description: "Search Snipe-IT. Returns 'not-configured' until OAuth/API credentials are supplied.",
  ...
  server.tool({
    name: "fetch",
    description: "Fetch a record from Snipe-IT by id or URL. Stub until configured.",
