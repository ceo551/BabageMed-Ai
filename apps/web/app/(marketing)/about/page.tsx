      ...
      <section className="mkt-section mkt-hero">
        <div className="mkt-wrap">
          ...
          <p className="mkt-trust">
            Web &amp; desktop · English &amp; العربية · Cited answers · Free plan with 500 monthly
            credits
          </p>
        </div>
      </section>
          ...
          <div className="mkt-grid mkt-grid--3" style={{ marginTop: 28 }}>
            <div className="mkt-card">
              ...
              <p>
                ...
                Claude Opus 4.8 and Sonnet 4.6, GPT 5.5/5.4, Gemini Pro 3.1, GLM 5.1, DeepSeek V4 Pro
                and Qwen 3.7 Max — so you can pick the right one for each task without switching tools
                or logins.
              </p>
            </div>
            <div className="mkt-card">
            ...
            <div className="mkt-card">
              ...
              <p>
                ...
                Notion, Slack, GitHub, Linear, Google Drive and more — and Agent Mode, the assistant
                reads and acts on your real data to finish multi-step work.
              </p>
            </div>
            <div className="mkt-card">
              <span className="mkt-card-ic">🌍</span>
              ...
              <p>
                ...
                with full right-to-left layout — an Arabic-English AI workspace that feels native in
                both directions, on web and desktop.
              </p>
            </div>
            <div className="mkt-card">
              <span className="mkt-card-ic">🔒</span>
        ...
        <div className="mkt-wrap">
          ...
          <div style={{ maxWidth: "68ch", margin: "24px auto 0" }}>
            <p className="mkt-sub" style={{ margin: "0 0 16px" }}>
              ...
              think and work in Arabic as well as English, even the basics — right-to-left text,
            ...
            <p className="mkt-sub" style={{ margin: 0 }}>
              ...
              analysts, founders and finance teams — for anyone who wants the leading models without
              the chaos, and who expects their assistant to respect both their language and their
              privacy. It is still early, and we ship constantly. The principles, though, will not
              change: the best models, your context, your tools, your data — yours.
            </p>
          </div>
        ...
        <div className="mkt-wrap">
          <div className="mkt-cta-band">
            ...
            <p className="mkt-sub">
              ...
              the Free plan includes 500 monthly credits and no credit card to begin.
            </p>
            <div className="mkt-cta-row">
              <Link href="/" className="mkt-btn mkt-btn-primary">
                Start free
