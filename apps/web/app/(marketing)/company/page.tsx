      ...
      <section className="mkt-section mkt-hero">
        <div className="mkt-wrap">
          ...
          <p className="mkt-lede">
            ...
            skills, real connectors and an Agent Mode — one calm place to do real work in your
        ...
        <div className="mkt-wrap">
          ...
          <div className="mkt-grid mkt-grid--3" style={{ marginTop: 28 }}>
            ...
            <Link href="/about" className="mkt-card" style={cardLink}>
              ...
              <p>
                The story and convictions behind Pervagans — why we built a privacy-first, genuinely
                bilingual workspace where your context, tools and data stay yours.
              </p>
            </Link>
        ...
        <div className="mkt-wrap">
          ...
          <div style={{ maxWidth: "68ch", margin: "24px auto 0" }}>
            <p className="mkt-sub" style={{ margin: "0 0 16px" }}>
              ...
              real data already lives — Notion, Slack, GitHub, Google and others.
            </p>
