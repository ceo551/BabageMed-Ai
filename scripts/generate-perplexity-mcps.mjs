...
//   - mcps/<id>/package.json   (npm scope @babagemed/mcp-<id>)
...
//   - infra/helm/babagemed/mcps-all.txt
//   - infra/helm/babagemed/mcps-index.json
...
const idxPath = path.join(ROOT, "infra/helm/babagemed/mcps-index.json");
...
function toolsTS(name, homepage) {
  ...
  return `import { z, McpServer } from "@babagemed/mcp-base";
