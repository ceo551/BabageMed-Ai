#!/usr/bin/env node
// Generates infra/helm/pervagans/mcps-index.json (id → {kind, port, name})
// and infra/helm/pervagans/mcps-all.txt (space-separated full id list).
...
const chartDir = join(ROOT, "infra", "helm", "pervagans");
