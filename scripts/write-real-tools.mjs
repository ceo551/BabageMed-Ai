...
w("pubmed", `import { z, McpServer, ApiClient } from "@babagemed/mcp-base";
...
const sites = [
  ...
  ["pathologyoutlines","https://www.pathologyoutlines.com", "https://www.pathologyoutlines.com/search.html?q={q}", { contentSelector: "main, article, .content, body" }],
